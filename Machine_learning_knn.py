...
layout = [[sg.Text('\t   Crop Recommendation Assistant', font=("Poppins", 28), text_color = '#333', background_color='#66ff99')],                                                    # Defining the layout of the Graphical User Interface. It consist of some text, Buttons, and blanks to take Input.
         [sg.Text('Enter ratio of Nitrogen in the soil\t\t\t:', font=("Poppins", 18), background_color='#66ff99', text_color = '#333'), sg.Input(font=("Poppins",18), size = (20,1) , background_color='#ccffdd')],
         [sg.Text('Enter ratio of Phosphorous in the soil\t\t\t:', font=("Poppins", 18), background_color='#66ff99', text_color = '#333'), sg.Input(font=("Poppins", 18),size = (20,1), background_color='#ccffdd')],
         [sg.Text('Enter ratio of Potassium in the soil \t\t\t:', font=("Poppins", 18), background_color='#66ff99', text_color = '#333'), sg.Input(font=("Poppins", 18),size = (20,1), background_color='#ccffdd')],
         [sg.Text('Enter average Temperature value around the field\t\t:', font=("Poppins", 18), background_color='#66ff99', text_color = '#333'), sg.Input(font=("Poppins", 18),size = (20,1), background_color='#ccffdd'), sg.Text('*C', font=("Poppins", 18), background_color='#66ff99', text_color = '#a6a6a6')],
         [sg.Text('Enter average percentage of Humidity around the field\t:', font=("Poppins", 18), background_color='#66ff99', text_color = '#333'), sg.Input(font=("Poppins", 18),size = (20,1), background_color='#ccffdd'), sg.Text('%', font=("Poppins", 18), background_color='#66ff99', text_color = '#a6a6a6')],
         [sg.Text('Enter PH value of the soil\t\t\t\t:', font=("Poppins", 18), background_color='#66ff99', text_color = '#333'), sg.Input(font=("Poppins", 18), background_color='#ccffdd',size = (20,1))],
         [sg.Text('Enter average amount of Rainfall around the field\t\t:', font=("Poppins", 18), background_color='#66ff99', text_color = '#333'), sg.Input(font=("Poppins", 18), background_color='#ccffdd',size = (20,1)),sg.Text('mm', font=("Poppins", 18), background_color='#66ff99', text_color = '#a6a6a6')],
         [sg.Text(size=(50,1),font=("Poppins",18) , background_color='#66ff99', text_color = '#333', key='-OUTPUT1-' )],
         [sg.Button('Submit', font=("Poppins", 18), size=(20,1)), sg.Button('Quit', font=("Poppins", 18), size=(20,1))] ]

sg.theme_background_color('#66ff99')
sg.theme_button_color('#5c85d6')
window = sg.Window('Sparkathon : Crop Recommendation Assistant', layout, font='Poppins')
